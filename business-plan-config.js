...
window.BUSINESS_PLAN = {
  ...
  weeklyCloserPlan: {
    '2026-09': {
      teams: [
        {key:'im',label:'IM — Ideal Marketing',supervisor:'Patrick Araújo',targets:[21904,21904,27380,27380,16468]},
        ...
        {key:'bc',label:'BC — Busca Cliente',supervisor:'Matheus Porto',targets:[21120,26400,26400,26400,10560]}
      ]
    }
  }
};
